...
public class WeChatController {
    ...
    public String authorize(@RequestParam("resultUrl") String resultUrl) {
        ...
        String redirectUrl = wxMpService.oauth2buildAuthorizationUrl("",
                WxConsts.OAuth2Scope.SNSAPI_USERINFO,URLEncoder.encode(resultUrl));
        //重定向
    ...
    public String qrAuthorize(@RequestParam("returnUrl") String returnUrl) {
        String url = "";
        String redirectUrl = wxOpenMpService.buildQrConnectUrl(url, WxConsts.QrConnectScope.SNSAPI_LOGIN, URLEncoder.encode(returnUrl));
        return "redirect:" + redirectUrl;
    }
